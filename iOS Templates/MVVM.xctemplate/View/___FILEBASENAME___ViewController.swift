...
final class ___VARIABLE_featureName___ViewController: UIViewController {
    ...
    // MARK: - Initializers
    required init() {
        ___VARIABLE_featureName___ViewModel = TestAppMocksManager.shared().hasMocks(for: "___VARIABLE_featureName___ProviderMock") ? ___VARIABLE_featureName___ViewModel(provider: ___VARIABLE_featureName___ProviderMock("___VARIABLE_featureName___ProviderMock")) : ___VARIABLE_featureName___ViewModel()
